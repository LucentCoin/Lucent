...
This mechanism has been integrated into Bitcore-Node-Lucent which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lucentpay/insight-api-lucent#web-socket-api](https://github.com/lucentpay/insight-api-lucent#web-socket-api)
* API: [https://github.com/lucentpay/insight-api-lucent#instantsend-transactions](https://github.com/lucentpay/insight-api-lucent#instantsend-transactions)
...
By default, the Lucent Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Lucent Core daemon:

...
This document provides guidelines for internationalization of the Lucent Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lucent_en.ts` remains unchanged.

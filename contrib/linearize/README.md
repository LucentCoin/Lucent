# Linearize
Construct a linear, no-fork, best version of the Lucent blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install lucent_hash

https://github.com/lucentpay/lucent_hash
...
JSON-RPC server. Running `lucentd` or `lucent-qt -server` will be sufficient.
...
* `input`: lucentd blocks/ directory containing blkNNNNN.dat

    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("LUCENT-light"), QVariant("light"));
    ui->theme->addItem(QString("LUCENT-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("LUCENT-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("LUCENT-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("LUCENT-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("LUCENT-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("LUCENT-traditional"), QVariant("trad"));

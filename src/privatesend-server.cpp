...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Lucent related functionality
...
/*
    ...
    allow endless transaction that would bloat Lucent and make it unusable. To

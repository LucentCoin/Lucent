...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in lucent.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("lucent.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Lucent features */
    { "lucent",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "lucent",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "lucent",               "gobject",                &gobject,                true,  {} },
    { "lucent",               "voteraw",                &voteraw,                true,  {} },

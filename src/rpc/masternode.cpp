...
UniValue masternode(const JSONRPCRequest& request)
{
    ...
    if (strCommand == "outputs") {
        ...
        pwalletMain->AvailableCoins(vPossibleCoins, true, NULL, false, ONLY_MN);
...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Lucent address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "lucent",               "masternode",             &masternode,             true,  {} },
    { "lucent",               "masternodelist",         &masternodelist,         true,  {} },
    { "lucent",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "lucent",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "lucent",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "lucent",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
